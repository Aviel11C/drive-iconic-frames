...
export const vehicles: Vehicle[] = [
  ...
  { slug: "1962-mercedes-190sl", name: "Mercedes 190 SL", year: 1962, category: "Vintage Classics", image: mercedesAsset.url, availability: "Reservation Only" },
  { slug: "1965-mustang-gt", name: "Mustang GT", year: 1965, category: "Vintage Classics", image: mustangAsset.url, availability: "Available" },
  { slug: "1954-chevy-3100", name: "Chevrolet 3100 Truck", year: 1954, category: "Vintage Classics", image: truckAsset.url, availability: "Available" },
  { slug: "1986-chevy-cobra", name: "Chevrolet Cobra", year: 1986, category: "Vintage Classics", image: cobraAsset.url, availability: "Limited" },

  // Luxury Vehicles
  { slug: "1986-rolls-corniche", name: "Rolls-Royce Corniche", year: 1986, category: "Luxury Vehicles", image: rollsAsset.url, availability: "Reservation Only" },
  ...
  { slug: "1962-piaggio-vespa-150gl", name: "Piaggio Vespa 150 GL", year: 1962, category: "Motorcycles & Vespas", image: vespaClassicAsset.url, availability: "Reservation Only" },

  // Boats & Watercraft
  { slug: "2021-chris-craft-center-console", name: "Chris-Craft Center Console", year: 2021, category: "Boats & Watercraft", image: chrisCraftAsset.url, availability: "Reservation Only" },
