...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ride4Movies | Luxury Picture Cars for Weddings, Films &" },
      ...
      { property: "og:title", content: "Ride4Movies | Luxury Picture Cars for Weddings, Films &" },
      { property: "og:description", content: "Rare vintage, exotic, and luxury picture cars for film productions, weddings, editorials and celebrity events. 25+ years serving Hollywood." },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#0c0c0c" },
      { name: "twitter:title", content: "Ride4Movies | Luxury Picture Cars for Weddings, Films &" },
      { name: "twitter:description", content: "Rare vintage, exotic, and luxury picture cars for film productions, weddings, editorials and celebrity events. 25+ years serving Hollywood." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/8f592927-3183-4a7a-bda2-e2c07c81aab1" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/8f592927-3183-4a7a-bda2-e2c07c81aab1" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "preconnect", href: "https://fonts.googleapis.com" },
      { rel: "preconnect", href: "https://fonts.gstatic.com", crossOrigin: "anonymous" },
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400&family=Inter:wght@200;300;400;500;600&display=swap" },
    ],
    scripts: [
      {
