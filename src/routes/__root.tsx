...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "A quietly curated atelier of vintage, classic and modern picture cars for film, editorial, weddings and luxury events. West Hollywood." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/69d84ed2-521e-450c-9e1e-cb767ef3a0eb" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/69d84ed2-521e-450c-9e1e-cb767ef3a0eb" },
    ],
    links: [
